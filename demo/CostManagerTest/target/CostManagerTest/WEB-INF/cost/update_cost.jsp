...
<div id="main">
    ...
    <form action="updateCost.do" method="get" class="main_form">
        ...
        <div class="input_info fee_type">
            <c:if test="${cost.costType==1}">
                <input type="radio" name="costType" checked="checked" value="1" id="monthly" onclick="feeTypeChange(1);" />
                <label for="monthly">包月</label>
                <input type="radio" name="costType"  id="package" onclick="feeTypeChange(2);" />
            ...
            <c:if test="${cost.costType==3}">
                ...
                <input type="radio" name="costType" id="package" onclick="feeTypeChange(2);" />
                <label for="package">套餐</label>
                <input type="radio" name="costType"  checked="checked" value="3" id="timeBased" onclick="feeTypeChange(3);" />
                <label for="timeBased">计时</label>
            </c:if>
