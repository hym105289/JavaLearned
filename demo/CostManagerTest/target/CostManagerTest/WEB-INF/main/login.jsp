...
<div class="login_box">
    ...
    <table>
        <tr>
            ...
            <td colspan="2"><input name="loginName" value="${param.loginName}" type="text" class="width150" /></td>
            <td class="login_error_info"><span class="required">30长度的字母、数字和下划线</span></td>
        </tr>
        <tr>
            <td class="login_info">密码：</td>
            <td colspan="2"><input name="loginPasswd" value="${param.loginPasswd}" type="password" class="width150" /></td>
